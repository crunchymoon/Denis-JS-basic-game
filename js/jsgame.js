"use strict";
//setGameStart runs two methods with one click
let GameManager = {
    ...
    resetPlayer: function (classType) {
        ...
        //creating the interface of the selected player
    ...
    //creating the arena part to choose enemies
    ...
    setFight: function () {
        ...
        // Create enemies
        let enemy00 = new Enemy("Warlock", 100, 0, 50, 100, 100);
        let enemy01 = new Enemy("Paladin", 200, 0, 150, 80, 120);
